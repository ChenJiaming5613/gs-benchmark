    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-6 py-24 font-sans text-zinc-900 dark:bg-black dark:text-zinc-50">
      <div className="max-w-2xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/eval"
            className="inline-flex h-11 items-center justify-center rounded-md bg-zinc-900 px-6 text-sm font-medium text-white transition hover:bg-zinc-800 dark:bg-zinc-100 dark:text-black dark:hover:bg-zinc-200"
          >
            Go to Evaluation
          </Link>
